...
function Payment() {
    return (
      <section className="features" id="payment">
            ...
            <p className='section-subtitle'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illo dolore ut ex explicabo reiciendis repellat beatae fugiat magni odio eum.</p>
